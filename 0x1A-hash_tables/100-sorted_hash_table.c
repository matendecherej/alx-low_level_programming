...
/**
 * shash_table_print - will print a sorted hash table
...
/**
 * shash_table_print_rev - will print a sorted hash table in reverse
 * @ht: hash table to print
 *
 * Return: void
 */
...
/**
 * shash_table_delete - does delete a sorted hash table
